    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Meus Indicados</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/publisher/dashboard">Publisher</a></li>
                            <li class="breadcrumb-item"><a href="#">Meus Indicados</a></li>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/usuarios/cadastrar">Listar Meus Indicados</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar meus indicados</h4>
                                            ...
                                            foreach($sql as $dados){
                                                ...
                                                echo '
                                                    <tr data-id="'.$dados->id.'">
                                                        ...
                                                        <td>'.$status.'</td>
                                                        <td>
                                                            <a href="/publisher/meus-indicados/cliques-por-dia/'.$dados->id.'" class="btn btn-sm btn-info">
                                                                Cliques por dia
                                                            </a>
                                                        </td>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/publisher/indicados/listar.blade.php ENDPATH**/ ?>