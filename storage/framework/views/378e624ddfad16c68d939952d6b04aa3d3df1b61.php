    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Editar Usuário Financeiro</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin/dashboard">Administrador</a></li>
                            <li class="breadcrumb-item"><a href="#">Usuários</a></li>
                            <li class="breadcrumb-item active">Editar usuário financeiro</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/financeiro/listar">Listar usuários</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::model( $sql[0], ['url' => ['admin/financeiro/editar', $sql[0]->id], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/usuario_financeiro/editar.blade.php ENDPATH**/ ?>