        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::open( ['url' => 'admin/materias/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Redator</label>
                                            <?php echo e(Form::select('idRedator', $arrayRedatores, null, ['class' => 'form-control '.( $errors->has('idRedator') ? ' is-invalid' : ''),
                                            'placeholder' => 'Selecione um redator para cadastrar essa matéria'])); ?>

                                            <?php $__errorArgs = ['idRedator'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/materias/cadastrar.blade.php ENDPATH**/ ?>