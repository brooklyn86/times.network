    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cliques por Dia</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/redator/dashboard">Redator</a></li>
                    ...
                    <div class="card box-shadow-1 border-warning">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <?php echo e(Form::model($input, ['url' => ['/admin/materias/clique-por-dia', ''], 'id' => 'formFiltrar', 'method' => 'GET'])); ?>

                                <div class="row">

                                    <div class="col-md-3">
                                        <label>Selecione um dia para filtrar</label>
                                        <?php echo e(Form::text('filtro_data', null, ['class' => 'form-control dataBrasil'])); ?>
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/materias/cliques_por_dia.blade.php ENDPATH**/ ?>