                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h3 class="info">R$ <?php echo e(number_format($sqlGanhosTotaisPublisherTotal[0]->somaValor,2,',','.')); ?></h3>
                    ...
                    <div class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h3 class="warning">R$ <?php echo e(number_format($sqlGanhosTotaisRedatorTotal[0]->somaValor,2,',','.')); ?></h3>
                    ...
                    <div class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h3 class="info"><?php echo e(number_format($sqlGanhosTotaisPublisherTotal[0]->somaVisitas,0,',','.')); ?></h3>
                    ...
                    <div class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h3 class="warning"><?php echo e(number_format($sqlGanhosTotaisRedatorTotal[0]->somaVisitas,0,',','.')); ?></h3>
                    ...
                    <div class="card-content">
                      <div class="media align-items-stretch">
                        ...
                        <div class="py-1 px-2 media-body">
                          ...
                          <h5 class="text-bold-400"><?php echo e(number_format($totalCadastradosPublisher[0]->total,0,',','.')); ?></h5>
                    ...
                    <div class="card-content">
                      <div class="media align-items-stretch">
                        ...
                        <div class="py-1 px-2 media-body">
                          ...
                          <h5 class="text-bold-400"><?php echo e(number_format($totalCadastradosRedator[0]->total,0,',','.')); ?></h5>
                          <div class="progress mt-1 mb-0" style="height: 7px;">
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/financeiro/contagem_geral.blade.php ENDPATH**/ ?>