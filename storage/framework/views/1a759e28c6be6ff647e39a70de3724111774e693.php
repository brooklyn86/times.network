        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::open( ['url' => 'admin/sites/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <?php echo e(Form::text('enderecoSite', null, ['class' => 'form-control '.( $errors->has('enderecoSite') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o endereço completo do site'])); ?>

                                            <?php $__errorArgs = ['enderecoSite'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <?php echo e(Form::text('linkAdmin', null, ['class' => 'form-control '.( $errors->has('linkAdmin') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o endereco do painel de administração'])); ?>

                                            <?php $__errorArgs = ['linkAdmin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/sites/cadastrar.blade.php ENDPATH**/ ?>