            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/materias/cadastrar">Cadastrar nova matéria</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr data-id="'.$dados->id.'">
                            ...
                            <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/admin/materias/editar/'.$dados->id.'">Editar</a>
    ...
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluirMateria', function(e){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/admin/materias/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/materias/listar.blade.php ENDPATH**/ ?>