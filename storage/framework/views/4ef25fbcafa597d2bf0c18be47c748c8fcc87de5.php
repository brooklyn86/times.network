    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Sites</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/sites/cadastrar">Cadastrar novo sites</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr data-id="'.$dados->id.'">
                           ...
                           <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/admin/sites/editar/'.$dados->id.'">Editar</a>
                                    <a class="dropdown-item clickExcluirSite" href="#" data-id="'.$dados->id.'">Excluir</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluirSite', function(e){
            var id = $(this).attr('data-id');

            Swal.fire({
                title: 'Excluir Site?',
                text: "Tem certeza que deseja excluir esse site? Essa ação não pode ser desfeita",
                icon: 'warning',
                ...
                if (result.value) {
                    window.location.href = '/admin/sites/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/sites/listar.blade.php ENDPATH**/ ?>