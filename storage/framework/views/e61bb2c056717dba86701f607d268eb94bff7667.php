                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <span class="mr-1 user-name text-bold-700"><?php echo e(Session::get('nomeGerente')); ?></span>
                                <span class="avatar avatar-online">
                                <img src="/assets_admin/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i>
                            </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="/gerente/meus-dados"><i class="ft-user"></i> Meus Dados</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/gerente/logout"><i class="ft-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item">
                    <a href="/gerente/materias/listar">
                        <i class="la la-home"></i>
                        <span class="menu-title" data-i18n="Dashboard">Materias</span>
                    </a>
                </li>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/gerente/include.blade.php ENDPATH**/ ?>