...
<head>
    ...
    <title>Visualizar Promoção</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Pontuação dos Publishers</h4>
                                    ...
                                    <table class="table table-striped table-bordered dataex-html5-export">
                                        ...
                                        if(count($sql2) > 0){
                                            foreach($sql2 as $dados){
                                                //if( intdiv($dados->somaVisitas, 1000) > 0){
                                                    echo '
                                                        <tr data-id="'.$dados->id.'">
                                                            <td>'.$dados->nome.'</td>
                                                            <td>'.$dados->email.'</td>
                                                            <td>'.$dados->nickname.'</td>
                                                            <td>'.intdiv($dados->somaVisitas, 1000).'</td>
                                                        </tr>
                                                    ';
                                                //}
                                            }
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/contagem_promocao/visualizar.blade.php ENDPATH**/ ?>