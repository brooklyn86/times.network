...
<head>
    ...
    <title>Listar Usuários Financeiro</title>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/financeiro/cadastrar">Cadastrar novo usuário</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr data-id="'.$dados->id.'">
                            ...
                            <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/admin/financeiro/editar/'.$dados->id.'">Editar</a>
                                    <a class="dropdown-item" href="/admin/admin-login/financeiro/'.$dados->id.'" target="_blank">Login na Conta</a>
    ...
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluir', function(e){
            ...
            Swal.fire({
                ...
                text: "Tem certeza que deseja excluir esse usuário? Essa ação não pode ser desfeita",
                icon: 'warning',
                ...
                if (result.value) {
                    window.location.href = '/admin/financeiro/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/usuario_financeiro/listar.blade.php ENDPATH**/ ?>