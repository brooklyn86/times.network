            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/redator/solicitar-saque">Solicitar Saque</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickCancelar', function(e){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/redator/minhas-solicitacoes-saque/cancelar/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/redator/financeiro/minhas_solicitacoes.blade.php ENDPATH**/ ?>