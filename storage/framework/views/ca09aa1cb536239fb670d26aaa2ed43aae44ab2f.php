    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Movimentação</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/redatores/dashboard">Redatores</a></li>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/usuarios/cadastrar">Minha Movimentação Financeira</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Movimentação</h4>
                                        ...
                                        if(count($sql) > 0){
                                            foreach($sql as $dados){
                                                ...
                                                if($dados->idTipoMovimentacao == 1){
                                                    $tipoMovimentacao = '<div class="badge badge-success">Crédito</div>';
                                                }else if($dados->idTipoMovimentacao == 1){
                                                    $tipoMovimentacao = '<div class="badge badge-info">Ajuste</div>';
                                                }
                        ...
                        <tr data-id="'.$dados->id.'">
                            ...
                            <td><div class="badge badge-danger">'.$dados->dataLancamento.'</div></td>
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/publisher/financeiro/listar.blade.php ENDPATH**/ ?>