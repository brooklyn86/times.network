    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Novo Usuário</h3>
        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::open( ['url' => 'admin/usuarios/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/usuarios/cadastrar.blade.php ENDPATH**/ ?>