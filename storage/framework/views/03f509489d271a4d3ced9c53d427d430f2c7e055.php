...
<head>
    ...
    <title>Listar Solicitações de Saque</title>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Solicitações de Saque</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/financeiro/dashboard">Financeiro</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Solicitações de Saque</h4>
                                    ...
                                    <table class="table table-striped table-bordered dataex-html5-export">
                                        ...
                                        if(count($sql) > 0){
                                            foreach($sql as $dados){
                                                ...
                                                $sqlinfo = DB::table('informacoes_pagamento')->where('idUsuario', $dados->idUsuario)
                                                    ->where('tipoPessoa', $dados->tipoUsuario)->get();
                                                ...
                                                if(count($sqlinfo) > 0){
                                                    $nomeTitular = $sqlinfo[0]->nomeTitular;
                                                    if($sqlinfo[0]->tipoPessoa == 1){
                                                        $tipoPessoa = 'Fisica';
                                                    }else{
                                                        $tipoPessoa = 'Jurídica';
                                                    }

                                                    $cpfCnpj = $sqlinfo[0]->cpfCnpj;
                                                    $nomeBanco = $sqlinfo[0]->nomeBanco;
                                                    $agencia = $sqlinfo[0]->agencia;
                                                    $numeroConta = $sqlinfo[0]->numeroConta;

                                                    if($sqlinfo[0]->tipoConta == 1){
                                                ...
                                                if($dados->tipoUsuario == 1){
                                                    $tipoUsuario = '<div class="badge badge-success">Publisher</div>';
                                                    $sql2 = DB::table('usuarios')->where('id', $dados->idUsuario)->get();
                                                }else if($dados->tipoUsuario == 2){
                                                    $tipoUsuario = '<div class="badge badge-info">Redator</div>';
                                                    $sql2 = DB::table('redatores')->where('id', $dados->idUsuario)->get();
                                                }

                                                $usuario = '';
                                                if(count($sql2) > 0){
                                                    $usuario = $sql2[0]->email.'<br>'.$sql2[0]->nome;
                                                }
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu arrow">';
                                        echo '<a class="dropdown-item" href="/financeiro/saques/editar/'.$dados->id.'" data-id="'.$dados->id.'">Editar/Atualizar</a>';
                                    echo '
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/financeiro/financeiro/listar_saques.blade.php ENDPATH**/ ?>