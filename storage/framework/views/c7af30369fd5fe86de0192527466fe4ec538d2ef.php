                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-warning">
                        <div class="card-header card-head-inverse bg-warning">
                            <h4 class="card-title text-white" id="basic-layout-form">Filtrar</h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <?php echo e(Form::model($input, ['url' => ['publisher/materias', ''], 'id' => 'formFiltrar', 'method' => 'GET'])); ?>

                                <div class="row">
                                    <div class="col-md-2">
                                        <label>Ordenar Por</label>
                                        <?php echo e(Form::select('filtro_orderBy', [
                                            'data-cadastro-desc' => 'Mais Recentes',
                                            'data-cadastro-asc' => 'Mais Antigas',
                                            'clique-hoje' => 'Mais Clicadas Hoje',
                                            'clique-semana' => 'Mais Clicadas Semana',
                                            'clique-mes' => 'Mais Clicadas Mês'
                                        ], null, ['class' => 'form-control'])); ?>

                                    </div>
                                    <div class="col-md-2">
                                        <label>Filtrar por Categoria</label>
                                        <?php echo e(Form::select('filtro_idCategoria', $arrayCategorias, null, ['class' => 'form-control'])); ?>

                                    </div>
                                    <div class="col-md-2">
                                        <label>Filtrar por Site</label>
                                        <?php echo e(Form::select('filtro_idSite', $arraySites, null, ['class' => 'form-control'])); ?>

                                    </div>
                                    <div class="col-md-3">
                                        <label>Filtrar por Título da Matéria</label>
                                        <?php echo e(Form::text('filtro_tituloMateria', null, ['class' => 'form-control'])); ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Resultados</h4>
                            <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-6">
                                                    <div class="card box-shadow-2" style="box-shadow: 0 10px 18px 0 rgba(62,57,107,.2) !important;">
                                                        ...
                                                        <div class="card-body" style="padding-left: .5rem; padding-right: .5rem; padding-top: 1rem">
                                                            ...
                                                            <span class="float-left font-small-2 text-muted">Adicionado em: '.$dados->dataCadastro.'</span>
                                                            </div></div>
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/publisher/materias/index.blade.php ENDPATH**/ ?>