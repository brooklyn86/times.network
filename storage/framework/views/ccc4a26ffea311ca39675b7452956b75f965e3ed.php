    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Editar Configurações</h3>
        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::model($sql[0], ['url' => ['admin/configuracoes', ''], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>


                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Configurações</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label>Valor CPM (em R$)</label>
                                            <?php echo e(Form::text('cpmAtual', null, ['class' => ' decimal_mask form-control '.( $errors->has('cpmAtual') ? ' is-invalid' : ''),
                                            'placeholder' => 'Valor do CPM em R$'])); ?>

                                            <?php $__errorArgs = ['cpmAtual'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>Porcentagem do Redator (em %)</label>
                                            <?php echo e(Form::text('porcentagemRedatores', null, ['class' => ' decimal_mask form-control '.( $errors->has('porcentagemRedatores') ? ' is-invalid' : ''),
                                            'placeholder' => 'Valor da porcentagem dos redatores em %'])); ?>

                                            <?php $__errorArgs = ['porcentagemRedatores'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>Valor Mínimo de Saque (em R$)</label>
                                            <?php echo e(Form::text('valorMinimoSaque', null, ['class' => ' decimal_mask form-control '.( $errors->has('valorMinimoSaque') ? ' is-invalid' : ''),
                                            'placeholder' => 'Valor mínimo de saque, em R$'])); ?>

                                            <?php $__errorArgs = ['valorMinimoSaque'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(e){
            ...
            $('.decimal_mask').mask('000.000.000,00', {reverse: true});
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/configuracoes/editar.blade.php ENDPATH**/ ?>