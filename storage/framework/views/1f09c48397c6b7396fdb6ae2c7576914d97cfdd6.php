...
<head>
    ...
    <title>Contador de Matérias</title>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Contador</h3>
                    ...
                    <div class="card box-shadow-1 border-warning">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <?php echo e(Form::model($input, ['url' => ['/admin/usuarios/contador', ''], 'id' => 'formFiltrar', 'method' => 'GET'])); ?>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/usuarios/contador.blade.php ENDPATH**/ ?>