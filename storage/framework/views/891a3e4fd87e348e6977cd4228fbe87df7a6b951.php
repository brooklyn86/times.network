    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Redatores</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/redatores/cadastrar">Listar redatores</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Redatores</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered dataex-html5-export">
                                        <thead>
                                            ...
                                            <th>Nome</th>
                                            <th>Email</th>
                                            <th>Qtd de Matérias Aprovadas</th>
                                            <th>Status</th>
                                            <th>Crédito Atual</th>
                                            <th>Ações</th>
                                        </thead>
                                        ...
                                        if(count($sql) > 0){
                                            foreach($sql as $dados){
                                                ...
                                                $sql2 = DB::table('materias')->where('status', 1)->where('idRedator', $dados->id)->select(DB::raw("count(*) as total"))->get();
                        ...
                        <tr data-id="'.$dados->id.'">
                            ...
                            <td>'.$dados->nome.'</td>
                            <td>'.$dados->email.'</td>
                            <td><div class="badge badge-info">'.$total.'</div></td>
                            <td>'.$status.'</td>
                            <td>R$ '.number_format($dados->valorCreditoAtual,2,',','.').'</td>
                            <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/admin/redatores/editar/'.$dados->id.'">Editar</a>
                                    <a class="dropdown-item" href="/admin/admin-login/redator/'.$dados->id.'" target="_blank">Login na Conta</a>
                                    <a class="dropdown-item clickExcluir" href="#" data-id="'.$dados->id.'">Excluir</a>
                                    <a class="dropdown-item clickLancar" href="#" data-id="'.$dados->id.'">Lançamento Crédito</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('#btnSalvar').click(function(e){
            ...
            console.log($('input[name=currentId]').val());
            console.log($('input[name=valor]').val());
            console.log($('select[name=idTipoMovimentacao]').val());
            $.ajax({
        ...
        $('body').on('click', '.clickExcluir', function(e){
            var id = $(this).attr('data-id');

            Swal.fire({
                title: 'Excluir Redator?',
                text: "Tem certeza que deseja excluir esse redaotor? Essa ação não pode ser desfeita",
                icon: 'warning',
                ...
                if (result.value) {
                    window.location.href = '/admin/redator/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/redatores/listar.blade.php ENDPATH**/ ?>