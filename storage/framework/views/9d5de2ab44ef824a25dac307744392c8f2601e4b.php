            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/gerente/materias/cadastrar">Cadastrar nova matéria</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Matérias</h4>
                                        ...
                                        if(count($sql) > 0){
                                            foreach($sql as $dados){
                                                ...
                                                if($dados->status == 1){
                                                    ...
                                                    $status = '<div class="badge badge-danger">Inativo</div>';
                                                }
                        ...
                        <tr data-id="'.$dados->id.'">
                            ...
                            <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/gerente/materias/editar/'.$dados->id.'">Editar</a>
    ...
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluirMateria', function(e){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/gerente/materias/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/gerente/materias/listar.blade.php ENDPATH**/ ?>