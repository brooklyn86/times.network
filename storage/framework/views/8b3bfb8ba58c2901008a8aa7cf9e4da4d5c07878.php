...
<head>
    ...
    <title>Cadastrar novo redator</title>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Novo Redator</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cadastrar novo redator</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::open( ['url' => 'admin/redatores/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/redatores/cadastrar.blade.php ENDPATH**/ ?>