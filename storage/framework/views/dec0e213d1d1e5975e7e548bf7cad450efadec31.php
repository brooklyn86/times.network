                                    ...
                                    <table class="table table-striped table-bordered dataex-html5-export">
                                        ...
                                        if(count($sql) > 0){
                                            foreach($sql as $dados){
                                                ...
                                                $sqlinfo = DB::table('informacoes_pagamento')->where('idUsuario', $dados->idUsuario)->get();
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/financeiro/financeiro/listar_saques.blade.php ENDPATH**/ ?>