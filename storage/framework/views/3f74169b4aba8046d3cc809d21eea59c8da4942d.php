    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar FAQ</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/faq/cadastrar">Cadastrar nova item</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar FAQ</h4>
                        ...
                        <tr data-id="'.$dados->id.'">
                            ...
                            <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/admin/faq/editar/'.$dados->id.'">Editar</a>
...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluirMateria', function(e){
            ...
            Swal.fire({
                title: 'Excluir FAQ?',
                text: "Tem certeza que deseja excluir essa item do FAQ? Essa ação não pode ser desfeita",
                icon: 'warning',
                ...
                if (result.value) {
                    window.location.href = '/admin/faq/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/faq/listar.blade.php ENDPATH**/ ?>