        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::model($sql, ['url' => ['admin/saques/editar', $sql->id], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true' ])); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label>Status</label>
                                                <?php echo e(Form::select('status', $arrayOpcoes, null, ['class' => 'form-control '.( $errors->has('status') ? ' is-invalid' : ''),
                                                ])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                <label>Anexo</label>
                                                <?php echo e(Form::file('comprovante', ['class' => 'form-control '.( $errors->has('comprovante') ? ' is-invalid' : ''),
                                                'placeholder' => 'Selecione uma imagem'])); ?>

                                                <?php $__errorArgs = ['comprovante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/financeiro/editar_saque.blade.php ENDPATH**/ ?>