    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Gerentes</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin/dashboard">Administrador</a></li>
                            <li class="breadcrumb-item"><a href="#">Gerentes</a></li>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/gerentes/cadastrar">Cadastrar novo Gerente</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Gerentes</h4>
    ...
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluir', function(e){
            ...
            Swal.fire({
                ...
                text: "Tem certeza que deseja excluir esse gerente? Essa ação não pode ser desfeita",
                icon: 'warning',
                ...
                if (result.value) {
                    window.location.href = '/admin/gerentes/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/gerentes/listar.blade.php ENDPATH**/ ?>