    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item">
                    <a href="/admin/contagem-promocao">
                        <i class="la la-cog"></i>
                        <span class="menu-title" data-i18n="Dashboard">Contador</span>
                    </a>
                </li>

                <li class=" nav-item">
                    <a href="/admin/ganhos-gerais">
                        <i class="la la-cog"></i>
                        <span class="menu-title" data-i18n="Dashboard">Ganhos Gerais</span>
                    </a>
                </li>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/include.blade.php ENDPATH**/ ?>