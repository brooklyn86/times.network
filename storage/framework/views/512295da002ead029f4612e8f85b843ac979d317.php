    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Categorias</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/categorias/cadastrar">Cadastrar nova categoria</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Sites</h4>
                        ...
                        <tr data-id="'.$dados->id.'">
                           ...
                           <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    <a class="dropdown-item" href="/admin/categorias/editar/'.$dados->id.'">Editar</a>
                                    <a class="dropdown-item clickExcluirCategoria" href="#" data-id="'.$dados->id.'">Excluir</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/categorias/listar.blade.php ENDPATH**/ ?>