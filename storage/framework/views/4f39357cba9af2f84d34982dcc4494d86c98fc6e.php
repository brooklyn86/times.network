        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    <?php echo e(Form::model($sql, ['url' => ['admin/usuarios/editar', $sql->id], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] )); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>Status</label>
                                            <?php echo e(Form::select('status', ['1' => 'Ativo', '2' => 'Inativo', '3' => 'Suspenso'], null, ['class' => 'form-control '.( $errors->has('status') ? ' is-invalid' : ''),
...
<?php /**PATH /home/times-news/webapps/timesnews_network/resources/views/admin/usuarios/editar.blade.php ENDPATH**/ ?>