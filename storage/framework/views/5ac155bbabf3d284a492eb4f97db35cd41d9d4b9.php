                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content px-1 pt-1">
                                    <div role="tabpanel" class="tab-pane active" id="tab31" aria-expanded="true" aria-labelledby="base-tab31">
                                        <div class="form-body">
                                            <h4 class="form-section"> Meus Dados</h4>

                                            <?php echo e(Form::model($sql, ['url' => ['gerente/meus-dados', ''], 'class' => 'form', 'id' => 'formSalvar'])); ?>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/gerente/meus-dados.blade.php ENDPATH**/ ?>