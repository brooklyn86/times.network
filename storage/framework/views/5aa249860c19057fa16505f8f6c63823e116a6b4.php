            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="alert round bg-info alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
                        ...
                        Quer indicar alguem? Utilize o link abaixo<br><b>https://timesnews.network/publisher/cadastro?indicador=<?php echo e($sql->codigoUnico); ?></b>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                <?php
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12 card-gradient-md-border border-right-info border-right-lighten-3">
                                    <div class="card-body text-center">
                                        <h1 class="display-4 text-white"><i class="icon-user font-large-2"></i> <?php echo e($visitasHoje); ?></h1>
                                        <span class="text-white">Vistas Hoje</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 card-gradient-md-border border-right-info border-right-lighten-3">
                                    <div class="card-body text-center">
                                        <h1 class="display-4 text-white"><i class="icon-user font-large-2"></i> <?php echo e($visitasMes); ?></h1>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 card-gradient-md-border border-right-lighten-3">
                                    <div class="card-body text-center">
                                        <h1 class="display-4 text-white"><i class="icon-money font-large-2"></i> R$ <?php echo e(number_format($sql->valorCreditoAtual,2,',','.')); ?></h1>
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/publisher/dashboard/index.blade.php ENDPATH**/ ?>