    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Listar Usuários</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/usuarios/cadastrar">Cadastrar novo usuário</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Listar Usuários</h4>
                                    ...
                                    <table class="table table-striped table-bordered dataex-html5-export">
                                        ...
                                        if(count($sql) > 0){
                                            foreach($sql as $dados){
                                                ...
                                                }elseif($dados->idStatus == 3){
                                                    $status = '<div class="badge badge-danger">Suspenso</div>';
                                                }

                                                $sqlIndicados = DB::table('usuarios')->where('idindicador', $dados->id)->select(DB::raw("count(*) as total"))->get();

                                                $totalindicados = 0;

                                                if(count($sqlIndicados) > 0){
                                                    $totalindicados = $sqlIndicados[0]->total;
                                                }
                            ...
                            <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu arrow">
                                    ...
                                    <a class="dropdown-item" href="/admin/admin-login/publisher/'.$dados->id.'" target="_blank">Login na Conta</a>
                                    <a class="dropdown-item clickLancar" href="#" data-id="'.$dados->id.'">Lançamento Crédito</a>
                                    <a class="dropdown-item" href="/admin/usuarios/ver-indicados/'.$dados->id.'" data-id="'.$dados->id.'">Ver Indicados</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('body').on('click', '.clickExcluirCategoria', function(e){
            var id = $(this).attr('data-id');

            Swal.fire({
                title: 'Excluir Categoria?',
                text: "Tem certeza que deseja excluir essa categoria? Essa ação não pode ser desfeita",
                icon: 'warning',
                ...
                if (result.value) {
                    window.location.href = '/admin/categorias/excluir/' + id;
                }
            });
        });
...
<?php /**PATH /home/times-news/timesnews.network/resources/views/admin/usuarios/listar.blade.php ENDPATH**/ ?>