            ...
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/redator/dashboard">Publisher</a></li>
        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::open( ['url' => 'redator/solicitar-saque', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}
        ...
        <div class="card-content">
          <div class="media align-items-stretch bg-gradient-x-success text-white rounded">
            <div class="p-2 media-middle">
              <h1 class="text-white">R$ {{ number_format($sql->valorCreditoAtual, 2, ',', '.') }}</h1>
            </div>
