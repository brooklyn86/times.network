...
<head>
    ...
    <title>Editar Solicitação de Saque</title>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Editar Solicitação de  Saque</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/financeiro/dashboard">Financeiro</a></li>
                            <li class="breadcrumb-item"><a href="#">Financeiro</a></li>
                            <li class="breadcrumb-item active">Editar Solicitação Saque</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::model($sql, ['url' => ['financeiro/saques/editar', $sql->id], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true' ]) }}
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card box-shadow-1 border-info">
                                <div class="card-header card-head-inverse bg-info">
                                    <h4 class="card-title text-white" id="basic-layout-form">Editar Solicitação de Saque</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                {{ Form::text('valorSolicitado', null, ['class' => 'form-control '.( $errors->has('valorSolicitado') ? ' is-invalid' : ''),
                                                'placeholder' => 'Digite o valor solicitado', 'readonly' => 'readonly']) }}
                                                @error('valorSolicitado')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label>Status</label>
                                                {{ Form::select('status', $arrayOpcoes, null, ['class' => 'form-control '.( $errors->has('status') ? ' is-invalid' : ''),
                                                ]) }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                <label>Anexo</label>
                                                {{ Form::file('comprovante', ['class' => 'form-control '.( $errors->has('comprovante') ? ' is-invalid' : ''),
                                                'placeholder' => 'Selecione uma imagem']) }}
                                                @error('comprovante')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                            </div>
                                        </div>
                                    </div>
                                </div>
