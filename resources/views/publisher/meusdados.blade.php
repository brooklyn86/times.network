                                ...
                                <div class="tab-content px-1 pt-1">
                                    <div role="tabpanel" class="tab-pane active" id="tab31" aria-expanded="true" aria-labelledby="base-tab31">
                                        <div class="form-body">
                                            ...
                                            {{ Form::model($sql, ['url' => ['publisher/meus-dados/informacoes', ''], 'class' => 'form', 'id' => 'formSalvar']) }}
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        {{ Form::text('telefone', null, ['class' => 'form-control '.( $errors->has('telefone') ? ' is-invalid' : ''),
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab32" aria-expanded="true" aria-labelledby="base-tab32">
                                        <div class="form-body">
                                            ...
                                            {{ Form::open(['url' => 'publisher/meus-dados/alterar-senha', 'class' => 'form', 'id' => 'formSalvar2']) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    {{ Form::password('csenha', ['class' => 'form-control '.( $errors->has('csenha') ? ' is-invalid' : ''),
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab33" aria-expanded="true" aria-labelledby="base-tab33">
                                        <div class="form-body">
                                            ...
                                            {{ Form::model($sqlInformacoes[0], ['url' => 'publisher/meus-dados/informacoes-pagamento', 'class' => 'form', 'id' => 'formSalvar3']) }}
