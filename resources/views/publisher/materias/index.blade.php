                    ...
                    <div class="card box-shadow-1 border-warning">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                {{ Form::model($input, ['url' => ['publisher/materias', ''], 'id' => 'formFiltrar', 'method' => 'GET']) }}
                                <div class="row">
                                    <div class="col-md-2">
                                        <label>Ordenar Por</label>
                                        {{ Form::select('filtro_orderBy', [
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {{ Form::select('filtro_idCategoria', $arrayCategorias, null, ['class' => 'form-control']) }}
                                    </div>
                                    <div class="col-md-2">
                                        <label>Filtrar por Site</label>
                                        {{ Form::select('filtro_idSite', $arraySites, null, ['class' => 'form-control']) }}
                                    </div>
                                    <div class="col-md-3">
                                        <label>Filtrar por Título da Matéria</label>
                                        {{ Form::text('filtro_tituloMateria', null, ['class' => 'form-control']) }}
                                    </div>
                                    <div class="col-md-3">
                                        <label>&nbsp;</label>
