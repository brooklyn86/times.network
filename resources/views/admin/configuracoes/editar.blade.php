        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::model($sql[0], ['url' => ['admin/configuracoes', ''], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            {{ Form::text('cpmAtual', null, ['class' => ' decimal_mask form-control '.( $errors->has('cpmAtual') ? ' is-invalid' : ''),
                                            'placeholder' => 'Valor do CPM em R$']) }}
                                            @error('cpmAtual')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Porcentagem do Redator (em %)</label>
                                            {{ Form::text('porcentagemRedatores', null, ['class' => ' decimal_mask form-control '.( $errors->has('porcentagemRedatores') ? ' is-invalid' : ''),
                                            'placeholder' => 'Valor da porcentagem dos redatores em %']) }}
                                            @error('porcentagemRedatores')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Valor Mínimo de Saque (em R$)</label>
                                            {{ Form::text('valorMinimoSaque', null, ['class' => ' decimal_mask form-control '.( $errors->has('valorMinimoSaque') ? ' is-invalid' : ''),
                                            'placeholder' => 'Valor mínimo de saque, em R$']) }}
                                            @error('valorMinimoSaque')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
