    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Editar Usuário</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/usuarios/listar">Listar usuários</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::model($sql, ['url' => ['admin/usuarios/editar', $sql->id], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}

                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Dados do usuário</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            'placeholder' => 'Se deseja alterar a senha do cliente, digite aqui. Para manter a senha, deixe em branco']) }}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            {{ Form::text('urlPost', null, ['class' => 'form-control '.( $errors->has('urlPost') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite a URL do POST']) }}
                                            @error('urlPost')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            'placeholder' => 'Digite o telefone com DDD do usuário']) }}
                                            @error('telefone')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Nickname (Apelido)</label>
                                            {{ Form::text('nickname', null, ['class' => 'form-control '.( $errors->has('nickname') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o nickname / apelido desse usuário']) }}
                                            @error('nickname')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Status</label>
                                            {{ Form::select('status', ['1' => 'Ativo', '2' => 'Inativo', '3' => 'Suspenso'], null, ['class' => 'form-control '.( $errors->has('status') ? ' is-invalid' : ''),
