    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Novo Site</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cadastrar novo site</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/sites/listar">Listar sites</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::open( ['url' => 'admin/sites/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}

                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Dados do site</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            {{ Form::text('enderecoSite', null, ['class' => 'form-control '.( $errors->has('enderecoSite') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o endereço completo do site']) }}
                                            @error('enderecoSite')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Status</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label>Link do Administrador</label>
                                            {{ Form::text('linkAdmin', null, ['class' => 'form-control '.( $errors->has('linkAdmin') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o endereco do painel de administração']) }}
                                            @error('linkAdmin')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
