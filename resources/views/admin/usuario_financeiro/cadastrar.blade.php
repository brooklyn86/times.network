...
<head>
    ...
    <title>Cadastrar Financeiro</title>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Novo Usuário Financeiro</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin/dashboard">Administrador</a></li>
                            <li class="breadcrumb-item"><a href="#">Usuários</a></li>
                            <li class="breadcrumb-item active">Cadastrar novo usuário financeiro</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::open( ['url' => 'admin/financeiro/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}
