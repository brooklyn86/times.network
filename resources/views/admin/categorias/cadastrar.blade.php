    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Nova Categoria</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/categorias/listar">Listar categorias</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::open( ['url' => 'admin/categorias/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}

                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Dados da categoria</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            {{ Form::text('nomeCategoria', null, ['class' => 'form-control '.( $errors->has('nomeCategoria') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o título dessa categoria']) }}
                                            @error('nomeCategoria')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Status</label>
