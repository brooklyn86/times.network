            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/sites/listar">Listar categorias</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::model( $sql, ['url' => ['admin/categorias/editar', $sql->id], 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}
