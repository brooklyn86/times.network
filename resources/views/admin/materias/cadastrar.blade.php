    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Nova Matéria</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cadastrar nova matéria</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/materias/listar">Listar matérias</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::open( ['url' => 'admin/materias/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            {{ Form::file('imagemThumb', ['class' => 'form-control '.( $errors->has('imagemThumb') ? ' is-invalid' : ''),
                                            'placeholder' => 'Selecione a imagem da thumbnail']) }}
                                            @error('imagemThumb')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label>Link da Materia</label>
                                            {{ Form::text('linkSite', null, ['class' => 'form-control '.( $errors->has('linkSite') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o link da matéria']) }}
                                            @error('titulo')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Redator</label>
                                            {{ Form::select('idRedator', $arrayRedatores, null, ['class' => 'form-control '.( $errors->has('idRedator') ? ' is-invalid' : ''),
                                            'placeholder' => 'Selecione um redator para cadastrar essa matéria']) }}
                                            @error('idRedator')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label>Link de Referência</label>
                                            {{ Form::text('linkReferencia', null, ['class' => 'form-control '.( $errors->has('linkReferencia') ? ' is-invalid' : ''),
                                            'placeholder' => 'Digite o link de referência da matéria']) }}
                                            @error('linkReferencia')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label>Categoria</label>
                                            {{ Form::select('idCategoria', $arrayCategorias, null, ['class' => 'form-control '.( $errors->has('idCategoria') ? ' is-invalid' : ''),
                                            'placeholder' => 'Selecione uma categoria']) }}
                                            @error('idCategoria')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Site</label>
                                            {{ Form::select('idSite', $arraySites, null, ['class' => 'form-control '.( $errors->has('idSite') ? ' is-invalid' : ''),
                                            'placeholder' => 'Selecione um site']) }}
                                            @error('idSite')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Status</label>
                                            {{ Form::select('status', ['1' => 'Ativo', '0' => 'Inativo'], null, ['class' => 'form-control '.( $errors->has('status') ? ' is-invalid' : ''),
                                            ]) }}
