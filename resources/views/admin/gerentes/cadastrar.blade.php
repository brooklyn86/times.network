...
<head>
    ...
    <title>Cadastrar novo Gerente</title>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Cadastrar Novo Gerente</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cadastrar novo gerente</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    ...
                    <div class="dropdown-menu arrow">
                        <a class="dropdown-item" href="/admin/gerentes/listar">Listar gerentes</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body">
            <div class="row match-height">
                <div class="col-md-12">
                    ...
                    {{ Form::open( ['url' => 'admin/gerentes/cadastrar', 'class' => 'form', 'id' => 'formSalvar', 'files' => 'true'] ) }}

                    <div class="card box-shadow-1 border-info">
                        <div class="card-header card-head-inverse bg-info">
                            <h4 class="card-title text-white" id="basic-layout-form">Dados do gerente</h4>
